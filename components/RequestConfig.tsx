    ...
    <div className="grid grid-cols-1 gap-3">
      <div className="flex gap-3 items-center">
        <select
          ...
          className="rounded-md bg-transparent border border-white/6 p-2 transition-shadow focus:shadow-[0_0_18px_rgba(99,102,241,0.08)] focus:border-indigo-400"
        >
          <option>GET</option>
          <option>POST</option>
          <option>PUT</option>
        ...
        <div className="flex-1">
          ...
          <textarea
            ...
            className="w-full rounded-md bg-transparent border border-white/6 p-2 mt-1 text-xs h-16 transition-shadow focus:shadow-[0_0_18px_rgba(99,102,241,0.08)] focus:border-indigo-400"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-md bg-transparent border border-white/6 p-2 mt-1 text-xs h-24 transition-shadow focus:shadow-[0_0_18px_rgba(99,102,241,0.08)] focus:border-indigo-400"
      ...
      <div className="flex gap-4 items-center">
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="w-20 rounded-md bg-transparent border border-white/6 p-2 transition-shadow focus:shadow-[0_0_18px_rgba(99,102,241,0.08)] focus:border-indigo-400"
          />
        </div>
